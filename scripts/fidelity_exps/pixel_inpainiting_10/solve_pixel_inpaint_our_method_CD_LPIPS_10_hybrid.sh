...
TAU=1.5e-5 # does not matter when we are decaying the tau value in prefixed range
...
CM_SOLVER="hybrid" # supported solvers - "heun", "dpm", "ancestral", "onestep", "progdist", "euler", "multistep"
...
# book-keeping
NUM_PLOT=1 # number of samples to plot 
PLOT_ALL=True
