...
EXP_DIR="./inverse_problem_results_baseline/"
...
# Degradation args
DEG="gaussian_deblur" # we use kernel size of 61 x 61 with sigma=3.0
...
SAMPLING_METHOD="cmedit"  # supported methods - ["cminv", "cmedit", "dps", "mpgd", "lgd"]
