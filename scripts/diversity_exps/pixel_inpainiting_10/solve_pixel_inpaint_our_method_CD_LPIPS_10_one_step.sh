...
EXP_DIR="./inverse_problem_results_our_method_diversity"
...
TAU=1.0e-4 # does not matter when we are decaying the tau value in prefixed range
DECAY_TAU=False
BLEND_ALPHA=0.45 # blend init hyper-parameter
INIT_TYPE="warm" # can be rand, Apy, or gt
WARM_INIT_TYPE="rand"
WARM_SOLVER="ADAM"
WARM_LR=0.0005 # not applicable for SAM warmup
WARM_MOMENTUM=0.9
WARM_STEPS=400
NUM_LANG_STEPS=25 
